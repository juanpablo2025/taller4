...
public class taller4 {
	...
	public static void main(String[] args) {
		...
		if (i == 4) {
			...
			Scanner e = new Scanner(System.in);
			System.out.println("\n " + "Ingrese la estatura");
			Double estatura = e.nextDouble();

			Scanner s = new Scanner(System.in);
			System.out.println("\n " + "Ingrese el sexo: (F = femenino, M = masculino)");
			String sexo = s.next();

			if (edad <= 17 && sexo.equals("M") || sexo.equals("m")) {
				System.out.print("\n " + "Debe ser myor de edad para estar en el equipo");

			}
			if (estatura <= 1.69 && sexo.equals("M") || sexo.equals("m")) {

				System.out.print("\n " + "Debes medir 1,70 o mas para estar en el equipo ");
			}
			if (peso > 45 && sexo.equals("M") || sexo.equals("m")) {
				System.out.print("\n " + "Debes pesar 45kg o menos para estar en el equipo ");
			}
			if (edad <= 16 && sexo.equals("F") || sexo.equals("f")) {
				System.out.print("\n " + "Debe ser myor de edad para estar en el equipo");

			}
			if (estatura <= 1.69 && sexo.equals("F") || sexo.equals("f")) {

				System.out.print("\n " + "Debes medir 1,70 o mas para estar en el equipo ");
			}
			if (peso > 60 && sexo.equals("F") || sexo.equals("f")) {
				System.out.print("\n " + "Debes pesar 60kg o menos para estar en el equipo ");
			} else {
				System.out.print("\n " + nombre + "Felicitaciones puedes ser parte del equipo");
			}
		...
		{
			System.out.print(i + ") "
					+ "ELABORAR UN PROGRAMA QUE LE PERMITA A UN USUARIO INGRESAR EL NOMBRE DE UN TRABAJADOR, Y EL NÚMERO DE HORAS TRABAJADAS, SE PIDE QUE EL PROGRAMA LE IMPRIMA EL SALARIO BRUTO, LAS BONIFICACIONES, LAS DEDUCCIONES Y EL SALARIO NETO; TENIENDO EN CUENTA QUE LAS BONIFICACIONES SERÁN DE $20.000.OO SI TRABAJÓ COMO MÁXIMO 48 HORAS, DE $50.000.OO SI TRABAJO ENTRE 49 Y 58 HORAS Y DE $100.000 SI TRABAJÓ MÁS DE 58 HORAS. LAS DEDUCCIONES SON DE $10.000 SI EL SALARIO BÁSICO HORA ES MENOR DE $5.000.OO, DE $20.000.OO SI EL SALARIO BÁSICO HORA ES MAYOR DE $5.000.OO Y MENOR DE $8.000.OO Y DE $ 50.000.OO SI SU SALARIO BÁSICO HORA ES DE $8.000.OO O MAS.");
